...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
C4x4GridPatchMesh::C4x4GridPatchMesh(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList) : CMesh(pd3dDevice, pd3dCommandList)
{
	...
	pxmf3Positions[0] = XMFLOAT3(-50.0f, -290.0f, +190.0f);
	pxmf3Positions[1] = XMFLOAT3(-25.0f, +280.0f, +190.0f);
	pxmf3Positions[2] = XMFLOAT3(+25.0f, -180.0f, +190.0f);
	pxmf3Positions[3] = XMFLOAT3(+50.0f, +190.0f, +190.0f);

	pxmf3Positions[4] = XMFLOAT3(-50.0f, -290.0f, +100.0f);
	pxmf3Positions[5] = XMFLOAT3(-25.0f, +280.0f, +100.0f);
	pxmf3Positions[6] = XMFLOAT3(+25.0f, -180.0f, +100.0f);
	pxmf3Positions[7] = XMFLOAT3(+50.0f, +190.0f, +100.0f);

	pxmf3Positions[8] = XMFLOAT3(-50.0f, -290.0f, -90.0f);
	pxmf3Positions[9] = XMFLOAT3(-25.0f, +280.0f, -90.0f);
	pxmf3Positions[10] = XMFLOAT3(+25.0f, -180.0f, -90.0f);
	pxmf3Positions[11] = XMFLOAT3(+50.0f, +190.0f, -90.0f);

	pxmf3Positions[12] = XMFLOAT3(-50.0f, -290.0f, -190.0f);
	pxmf3Positions[13] = XMFLOAT3(-25.0f, +280.0f, -190.0f);
	pxmf3Positions[14] = XMFLOAT3(+25.0f, -180.0f, -190.0f);
	pxmf3Positions[15] = XMFLOAT3(+50.0f, +190.0f, -190.0f);

	m_pd3dVertexBuffer = ::CreateBufferResource(pd3dDevice, pd3dCommandList, pxmf3Positions, m_nStride * m_nVertices, D3D12_HEAP_TYPE_DEFAULT, D3D12_RESOURCE_STATE_VERTEX_AND_CONSTANT_BUFFER, &m_pd3dVertexUploadBuffer);
...
C4x4GridPatchMesh::~C4x4GridPatchMesh()
{
}
