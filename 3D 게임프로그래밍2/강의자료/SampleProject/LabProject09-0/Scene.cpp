...
void CScene::BuildObjects(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
{
	...
	m_pTexture = new CTexture(2, RESOURCE_TEXTURE2D, 0, 2, 1, 1);
	...
	m_pTexture->SetGraphicsSrvRootParameterIndex(0, 0, 0);
	m_pTexture->SetGraphicsSrvRootParameterIndex(1, 1, 1);
